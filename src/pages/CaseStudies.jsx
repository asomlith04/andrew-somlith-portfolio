    ...
    lessons: [
      {
        ...
        detail:
          'Headlines that named the exact buyer pain outperformed clever, brand-forward copy every time. The best-performing variant read like a search query, not a slogan.',
      },
      {
        title: 'Every form field is a tax',
        detail:
          'Each additional field measurably lowered completion. Ask only for what sales truly needs in the first 24 hours — enrichment tools can fill the rest.',
      },
      {
        title: "Social proof works when it's adjacent to the CTA",
        detail:
          'Testimonials at the top of the page were skimmed past. Placing a logo bar or a short quote inline with the signup button shifted hesitation to action.',
      },
    ],
    ...
    lessons: [
      {
        ...
        detail:
          'The same copy performed wildly differently across personas. Treating existing users and cold prospects as one list would have wasted both groups — the tighter the segment, the sharper the message.',
      },
      {
        title: 'Behavioral triggers beat static schedules',
        detail:
          "Follow-ups sent in response to opens and clicks outperformed fixed time-delays. The buyer's signal is more valuable than your calendar.",
      },
      {
        title: 'Launch sequences are about sequencing, not volume',
        detail:
          'Six emails felt right. Earlier drafts had nine, and the extra touches cannibalized engagement rather than adding to it. Cutting is part of the craft.',
      },
    ],
    ...
    <main className="min-h-screen pt-24 pb-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <Link
            to="/work"
            className="text-[11px] font-bold uppercase tracking-[0.3em] text-p5-white/40 hover:text-p5-red transition-colors duration-150 cursor-pointer inline-flex items-center gap-2 mb-6"
          >
            ...
            >
              <div className="p-8 md:p-12">
                ...
                <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
                  <div>
                    <span
                      className={`p5-tag text-xs mb-3 inline-block ${
                        cs.accent === 'p5-red'
                          ? 'text-p5-red border-p5-red'
                          : 'text-p5-cyan border-p5-cyan'
                      }`}
                    >
                      {cs.tag}
                    </span>
